...
class DashboardController extends Controller
{
    public function index(OrderOverviewChart $chart)
    {
        ...
        $percentageOrderTotal = $sumOrderTotalYesterday ? (($sumOrderTotalToday - $sumOrderTotalYesterday) / $sumOrderTotalYesterday) * 100 : 100;
        ...
        $percentageOrder = $countOrderYesterday ? (($countOrderToday - $countOrderYesterday) / $countOrderYesterday) * 100 : 100;
